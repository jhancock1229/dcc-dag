...
export const NODES = [
  ...
  { id: "prepotente", label: "Prepotente", book: 3, faction: "CRAWLERS", role: "Aerialist", x: 310, y: 50,
    desc: "Miriam's beloved goat, transformed into a bipedal Caprid / Forsaken Aerialist by a pet biscuit on Floor 3. Name means 'arrogant and bossy' in Italian — accurate. Screams constantly and for no apparent reason. Starts out as a weird jerk, matures greatly. Terrifyingly smart underneath the chaos. After Miriam's death he's essentially unmoored and borderline dangerous. Eventually develops a frenemy relationship with Carl. On Floor 8 goes to the Bahamas with Bianca and keeps in contact with Carl. Breaks Floor 7 entirely, sending all crawlers to Floor 8 early." },
  { id: "bianca", label: "Bianca Del Ciao", book: 3, faction: "CRAWLERS", role: "Boss/Pet", x: 200, y: 50,
    desc: "One of Miriam's 15 boer goats, transformed on Floor 3 by an Enhanced Pet Biscuit into a horse-sized Hellspawn Familiar. Now jet-black with glowing red eyes, phantom black flames, and six human-like breasts — the system describes her as one of the most powerful pets available in the crawl. Enjoyed butt scratches and grapes as a regular goat. Eats Osvaldo's pet stone hawk Gimli on Floor 6. Stays bonded to Prepotente after Miriam's death; they go to the Bahamas together on Floor 8." },
  { id: "angelo", label: "Angelo", book: 3, faction: "BACKSTORY", role: "Pre-Dungeon", x: 200, y: 130,
    desc: "One of Miriam's 15 boer goats. Given an Enhanced Pet Biscuit on Floor 3 alongside Prepotente and Bianca, but his transformation 'didn't go so well,' resulting in his death and the deaths of several other goats. Never appears directly — mentioned only in passing — but his failed biscuit is what reduced the herd from 15 to 5 by Floor 4." },
...
export const EDGES = [
  ...
  { from: "miriam", to: "bianca", type: "companion", label: "goat owner/familiar bond" },
  { from: "miriam", to: "angelo", type: "companion", label: "goat owner (died in transformation)" },
  { from: "prepotente", to: "bianca", type: "companion", label: "travels together after Miriam" },
  { from: "bianca", to: "osvaldo", type: "killed", label: "eats his pet hawk Gimli" },
